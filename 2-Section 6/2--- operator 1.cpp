...
public:;
  ...
  //   if(hour==0&&min==0&&sec==0)   return Cmytime(hour=23,min=59,sec=59);
  //   if(min==0&&sec==0)            return Cmytime(hour=hour-1,min=59,sec=59);
  //   if(sec==0)                    return Cmytime(hour,min=min-1,sec=59);
  //   else                          return Cmytime(hour,min,sec=sec-1);};};
  Cmytime & operator--() {
